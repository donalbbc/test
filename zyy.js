...
let buton = [
{ callButton: {displayText: `Instagram`, url: `https://instagram.com/sonel._zi/`} },
{ urlButton: { displayText: `Call Owner`, phoneNumber : `+6282362020751`} },
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/sonel._z'
                                }
                            }, {
                                callButton: {
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'FN:ZyyXtrime\n'
    + 'ORG:ZyyXtrime;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=6282326020751:+62 823-2602-0751\n' 
    + 'item1.X-ABLabel:Creator SonelBotz\n'
    + 'item2.EMAIL;type=INTERNET: ytfauzigaming@gmail.com\n'
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://instagram.com/sonel._z\n'
